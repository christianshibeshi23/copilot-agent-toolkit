...
> **→ See [Agent Inventory — List View](https://github.com/christianshibeshi23/copilot-agent-toolkit/blob/main/AGENT_INVENTORY.md#list-view) for instructions on how to use Show more and verify this field.**
...
**→ [AGENT\_INVENTORY.md](https://github.com/christianshibeshi23/copilot-agent-toolkit/blob/main/AGENT_INVENTORY.md)**
...
4. See [AGENT\_INVENTORY.md](https://github.com/christianshibeshi23/copilot-agent-toolkit/blob/main/AGENT_INVENTORY.md) for full sync instructions.
