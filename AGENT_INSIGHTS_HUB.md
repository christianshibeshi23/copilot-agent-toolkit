...
3. **Azure App Registration** — An Azure AD app must be registered with access to the Application Insights telemetry data. Follow the setup guide: [Enable Application Insights Support](https://github.com/christianshibeshi23/copilot-agent-toolkit/blob/main/ENABLE-APPINSIGHTS.md#enable-application-insights-support).
...
Follow the complete setup guide: **[Enable Application Insights Support](https://github.com/christianshibeshi23/copilot-agent-toolkit/blob/main/ENABLE-APPINSIGHTS.md#enable-application-insights-support)**
