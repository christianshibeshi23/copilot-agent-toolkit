...
- **Keep solutions up to date** — Check the [Copilot Agent Kit releases](https://github.com/christianshibeshi23/copilot-agent-toolkit/releases) for new templates, components, and improvements.
...
- [Component Library documentation](https://github.com/christianshibeshi23/copilot-agent-toolkit/blob/main/COMPONENT_LIBRARY.md)
