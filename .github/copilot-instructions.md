# Copilot instructions — Copilot Agent Toolkit
...
The Copilot Agent Toolkit ships:
...
- **Power Platform solution files** (top-level folders) — the actual Kit
  ...
  environments.
- **A GitHub Pages landing page** at https://microsoft.github.io/copilot-agent-toolkit/
